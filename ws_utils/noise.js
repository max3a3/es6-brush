...
export let noiseProfile = { generator: undef, octaves: 4, fallout: 0.5, seed: undef};
...
// Yuriedit
// caching
noiseProfile.generator = new PerlinNoise(0) //noiseProfile.seed);

export const noise = function(x, y, z, octaves, fallout) {
...
* @see noise
*/
export const noiseDetail = function(octaves, fallout) {
